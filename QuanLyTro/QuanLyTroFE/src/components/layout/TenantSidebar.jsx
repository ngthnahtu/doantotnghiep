    ...
    <aside className="flex min-h-screen w-64 flex-col justify-between border-r border-slate-200 bg-white py-6 text-slate-800 shadow-md dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200">
      ...
      <div className="my-auto flex flex-1 flex-col justify-center gap-2">
        <nav className="flex flex-col gap-2">
          <NavLink to="/tenant/contract" className={navClass}>
            <FileText size={22} />
            <span>Hợp đồng</span>
          </NavLink>

          <NavLink to="/tenant/invoice" className={navClass}>
            <ReceiptText size={22} />
            <span>Hóa đơn</span>
          </NavLink>

          <NavLink to="/tenant/payment" className={navClass}>
            <CircleDollarSign size={22} />
            <span>Thanh toán</span>
          </NavLink>

          <NavLink to="/tenant/notification" className={navClass}>
            <Bell size={22} />
            <span>Thông báo</span>
          </NavLink>

          <NavLink to="/tenant/issue" className={navClass}>
