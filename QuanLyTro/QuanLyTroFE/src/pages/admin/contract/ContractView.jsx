    ...
    >
      <div className="max-h-[70vh] overflow-y-auto border rounded-xl p-4 dark:border-slate-700">
        ...
        <div className="border-b pb-3 text-center dark:border-slate-700">
          ...
          <span
            className={`mt-2 inline-block rounded-xl px-3 py-1 text-sm ${status.color}`}
          >
            {status.text}
          </span>
        </div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-4">
          <div className="border rounded-xl p-3 dark:border-slate-700">
            <h3 className="border-b pb-2 font-semibold dark:border-slate-700">
            ...
            <div className="mt-2 space-y-2 text-sm">
              ...
              <p>
                CCCD/CMND:{" "}
                <span className="font-medium">
                  {contract.tenants?.identity_number ??
                    "Chưa cập nhật"}
                </span>
              </p>
            </div>
        ...
        {/* Tiền thuê và chi tiết */}
        <div className="mt-4 grid grid-cols-2 gap-4">
          <div className="border rounded-xl p-3 dark:border-slate-700">
            <h3 className="border-b pb-2 font-semibold dark:border-slate-700">
              Giá thuê và tiền cọc
            </h3>
            ...
            <div className="mt-2 space-y-2 text-sm">
              ...
              <p>
                Tiền hoàn trả:{" "}
                <span className="font-medium">
                  {contract.returned_deposit !== null &&
                  contract.returned_deposit !== undefined
                    ? formatCurrency(
                        contract.returned_deposit
                      )
                    : "Chưa hoàn trả"}
                </span>
              </p>
        ...
        <div className="mt-4 border rounded-xl p-3 dark:border-slate-700">
          ...
          <div className="mt-3 overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {contract.contract_services?.length >
                0 ? (
                  contract.contract_services.map(
                    (contractService) => {
                      const service =
                  ...
                  <tr>
                    <td
                      colSpan={4}
                      className="border p-3 text-center dark:border-slate-700"
                    >
        ...
        <div className="mt-4 border rounded-xl p p-3 dark:border-slate-700">
          ...
          <p className="mt-2 text-sm">
            {contract.note ||
              "Không có ghi chú hoặc điều khoản bổ sung."}
          </p>
        </div>
