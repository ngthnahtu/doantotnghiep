    ...
    >
      <div className="max-h-[70vh] overflow-y-auto border rounded-xl p-4 dark:border-slate-700">
        ...
        <div className="border-b pb-3 text-center dark:border-slate-700">
          ...
          <span
            className={`mt-2 inline-block rounded px-3 py-1 text-sm ${status.color}`}
          >
            {status.text}
          </span>
        </div>
            ...
            <div className="mt-2 space-y-2 text-sm">
              <p>
                ...
                <span className="font-medium">
                  {invoice.contracts?.tenants?.name ??
                    "Không xác định"}
                </span>
              </p>
              ...
              <p>
                Số điện thoại:{" "}
                <span className="font-medium">
                  {invoice.contracts?.tenants?.phone ??
                    "Chưa cập nhật"}
                </span>
              </p>
              ...
              <p>
                CCCD/CMND:{" "}
                <span className="font-medium">
                  {invoice.contracts?.tenants
                    ?.identity_number ?? "Chưa cập nhật"}
                </span>
              </p>
            </div>
          </div>
        ...
        <div className="mt-4 rounded bg-gray-100 p-3 dark:bg-slate-800">
          <div className="flex justify-between">
            ...
            <span>
              {formatCurrency(invoice.room_price_snapshot)}
            </span>
          </div>
